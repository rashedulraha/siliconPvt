    ...
    data: [
      {
        ...
        description: "RAJUK-approved prime plots adjacent to Turag River featuring 100% verified legal titles and tailored payment structures.",
      ...
      },
      {
        ...
        description: "Engineered with 30ft & 40ft wide avenue roads, central mosque, educational zone, healthcare, and green walkways.",
      ...
      },
      {
        ...
        description: "Instant deed registration, clean land mutation, and legal advisory ensuring long-term asset security.",
