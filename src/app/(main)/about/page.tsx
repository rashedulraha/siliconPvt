...
export default function AboutPage() {
  ...
  return (
    <>
        ...
        <SectionContainer className="relative z-10">
          <motion.div
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-heading text-white tracking-tight leading-snug mb-4">
              Building Trust. <br />
              <span className="text-gold">Creating Sustainable Communities.</span>
            </h1>
        ...
        <SectionContainer className="relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed font-light max-w-2xl mx-auto">
              Silicon Real Estate (Pvt.) Ltd. is a highly trusted, eco-friendly, and planned real estate developer in Bangladesh, committed to ensuring safe, modern, and long-term value-driven housing. We implement every project by giving the highest priority to honesty, transparency, quality, and absolute legal security, so that our valued clients can build their dream addresses and make secure investments with complete peace of mind.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-muted/30 border-y border-border/50 relative overflow-hidden" id="mission">
        {/* Subtle Dot Pattern */}
        <div
          className="absolute inset-0 opacity-[0.03] pointer-events-none"
          style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
            <motion.div
              ...
              <p className="text-xs sm:text-sm text-muted-foreground font-light leading-relaxed">
                Our mission is to create the highest value for our clients' investments through the combination of integrity, quality, innovation, and professionalism. We are committed to providing reliable services, transparent business practices, and the effective use of modern technology to deliver sustainable solutions that ensure the long-term development of our clients, partners, employees, and society.
              </p>
            </motion.div>
      ...
      <section className="py-16 sm:py-20 bg-background relative overflow-hidden" id="journey">
        <SectionContainer>
      ...
      <section className="py-16 sm:py-20 bg-muted/40 border-y border-border/50 relative overflow-hidden" id="chairman">
        {/* Subtle Dot Pattern */}
        <div
          className="absolute inset-0 opacity-[0.03] pointer-events-none"
          style={{
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 bg-card border border-border/60 rounded-2xl p-7 sm:p-9 space-y-4 shadow-xs">
              ...
              <p className="text-xs sm:text-sm text-foreground/90 font-light leading-relaxed">
                "Welcome to Silicon Real Estate (Pvt.) Ltd. Our ultimate goal is to present legally secure, strategically located, and highly promising real estate projects where we work diligently to maximize the asset value of your investments. We implement every project so that our respected clients can make future investment decisions with absolute confidence.
              </p>
              <p className="text-xs sm:text-sm text-foreground/90 font-light leading-relaxed">
                Our vision is to lead the country's housing sector as a trusted, innovative, and value-driven organization. By prioritizing quality, professionalism, ethics, and customer satisfaction, we commit to creating sustainable developments and safe havens for individuals, families, and future generations. Your trust is our greatest inspiration. To honor that trust, we pledge to stand by your side as a reliable partner at every step of your journey."
              </p>
            </div>
          </div>
        </SectionContainer>
      ...
      <section className="py-16 sm:py-20 bg-background relative overflow-hidden" id="md">
        <SectionContainer>
          <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 bg-card border border-border/60 rounded-2xl p-7 sm:p-9 space-y-4 shadow-xs order-2 lg:order-1">
              ...
              <p className="text-xs sm:text-sm text-foreground/90 font-light leading-relaxed">
                "Every individual dreams of a beautiful, safe, and planned home at the end of the day. To turn that dream into reality, our 'Silicon City' project is being implemented under experienced management, following a well-planned design and complying with RAJUK's necessary rules and regulations. We are building a modern and livable residential space with a combination of renowned architects, engineers, urban planners, social workers, environmentalists, and other professionals.
              </p>
              <p className="text-xs sm:text-sm text-foreground/90 font-light leading-relaxed">
                In line with the layout plan of Silicon City, 30 and 40 feet wide roads, a football field, a cricket field, and a grand mosque have been constructed. Same way, a bridge is under processing over the Turag River to ensure easy and seamless commuting. For those who did not receive plot allotments despite applying to various RAJUK projects, Silicon City can be an ideal, secure, and promising residential project. I warmly invite you to become a proud owner of a plot in Silicon City, equipped with modern 21st-century amenities, and build a secure, planned, and prosperous housing environment for yourself and the next generation."
              </p>
            </div>
      ...
      <section className="py-16 sm:py-20 bg-muted/30 border-y border-border/50 relative overflow-hidden" id="team">
        {/* Subtle Dot Pattern */}
        <div
          className="absolute inset-0 opacity-[0.03] pointer-events-none"
          style={{
      ...
      <section className="py-16 sm:py-20 bg-background relative overflow-hidden" id="process">
        <SectionContainer>
          <div className="max-w-2xl mx-auto text-center space-y-3 mb-14">
            <span className="text-xs font-semibold uppercase tracking-widest text-primary font-heading">
              OUR WORK PROCESS
        ...
        <SectionContainer>
          ...
          <div className="max-w-3xl mx-auto bg-card border border-border/60 rounded-2xl p-7 sm:p-9 text-center space-y-4 shadow-xs">
            <p className="text-xs sm:text-sm text-foreground/90 font-light italic leading-relaxed">
              "Silicon Real Estate provided us the best land investment experience. Their absolute transparency in transactions, legally sound paperwork, and helpful customer support are truly outstanding. I highly recommend them to anyone planning for a secure future."
            </p>
            <div className="pt-2">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-3">
                ...
                <p className="text-white/80 text-xs sm:text-sm font-light leading-relaxed max-w-xl">
                  Let us help you find the perfect property for your future generations. Book a physical office discussion or request a guided site visit today.
                </p>
