  ...
  const values = [
    {
      icon: Shield,
      title: "Integrity",
      desc: "We operate with complete transparency and honesty in every transaction and documentation.",
    },
    {
      icon: Award,
      title: "Excellence",
      desc: "We set the highest standards in service, legal compliance, and client support.",
    },
    {
      icon: Heart,
      title: "Client-First",
      desc: "Your investment goals are our priority. We listen, advise, and deliver with precision.",
    },
    {
      icon: Target,
      title: "Transparency",
      desc: "Every plot, every deed, every rupee — fully disclosed, no surprises.",
    },
  ];
        ...
        <SectionContainer className="relative">
          <motion.div
            ...
            <p className="text-white/65 text-lg font-light leading-relaxed max-w-2xl">
              We're more than a real estate company — we're long-term partners
              in your wealth creation journey, providing RAJUK-approved, legally
              verified land across Dhaka's highest-growth corridors.
            </p>
          </motion.div>
        </SectionContainer>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
            <motion.div
              ...
              <div className="space-y-4 text-muted-foreground leading-[1.8] font-light text-base">
                <p>
                  Founded in 2013, Silicon Real Estate (Pvt.) Ltd. has grown
                  from a boutique land development firm into one of Dhaka's most
                  trusted property brands. Our journey began with a single
                  mission: make legal, verified land investment accessible to
                  every Bangladeshi family.
                </p>
                <p>
                  Today, with over 1,500 satisfied clients and 25+ completed
                  projects spanning more than 800 acres, we remain committed to
                  the same principles that built our reputation — transparency,
                  legal integrity, and exceptional client service.
                </p>
              </div>
            ...
            <motion.div
              ...
              <Image
                ...
                alt="Silicon Real Estate office and team"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 glass-dark rounded-xl p-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="font-medium text-2xl text-white">25+</div>
                    <div className="text-white/50 text-xs">Projects</div>
                  </div>
                  <div className="border-x border-white/10">
                    <div className="font-medium text-2xl text-accent">
                      1,500+
                    </div>
                    <div className="text-white/50 text-xs">Clients</div>
                  </div>
                  <div>
                    <div className="font-medium text-2xl text-white">800+</div>
                    <div className="text-white/50 text-xs">Acres</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((s, i) => (
              <motion.div
                ...
                <div className="text-white/50 text-xs font-medium uppercase tracking-[0.1em] mt-1">
                  {s.label}
                </div>
              </motion.div>
            ))}
        ...
        <SectionContainer>
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-5">
            ...
            <motion.h2
              ...
              className="font-medium text-display-md text-foreground">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group bg-card rounded-xl p-7 border border-border card-lift shadow-luxury text-center">
          ...
          <SectionContainer>
            <div className="text-center max-w-2xl mx-auto mb-14 space-y-5">
              ...
              <motion.h2
                ...
                className="font-medium text-display-md text-foreground">
                The Experts Behind{" "}
                <span className="text-gold">Every Visit</span>
              </motion.h2>
              <p className="text-muted-foreground text-lg font-light">
                Experienced professionals dedicated to making your property
                journey exceptional.
              </p>
            </div>
