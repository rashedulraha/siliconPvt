        ...
        <SectionContainer className="relative z-10">
          <div className="max-w-3xl space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium font-heading text-white tracking-tight leading-tight">
              Our Products & <span className="text-accent font-semibold">Professional Services</span>
            </h1>
        ...
        <SectionContainer className="space-y-12">
          <div className="max-w-3xl text-left space-y-2">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm md:text-base font-light leading-relaxed">
              Click through our seven specialized service pillars to explore detailed benefits and features.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICE_FEATURES.map((f) => (
              <div
                ...
                <div className="space-y-2">
                  <span className="text-xs font-mono font-medium text-primary block">{f.num}</span>
                  <h3 className="text-base sm:text-lg font-semibold font-heading text-foreground">{f.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                ...
                className="bg-card border border-border/60 rounded-3xl p-7 shadow-xs space-y-3 flex flex-col justify-between">
                <div className="space-y-2">
                  <span className="text-xs font-mono font-medium text-accent block">Step {st.step}</span>
                  <h3 className="text-base font-semibold font-heading text-foreground">{st.title}</h3>
                  <p className="text-xs text-muted-foreground font-light leading-relaxed">{st.desc}</p>
                </div>
              </div>
            ))}
          </div>
