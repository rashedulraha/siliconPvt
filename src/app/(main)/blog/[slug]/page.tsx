...
export default function BlogPostPage({
  ...
  return (
    <>
      <PageSEO
        title={`${post.title} — Silicon Real Estate Blog`}
      ...
      <Container className="py-8 max-w-4xl">
        ...
        {/* Content */}
        <article className="prose prose-lg dark:prose-invert max-w-none mt-8 prose-headings:font-heading prose-a:text-primary">
