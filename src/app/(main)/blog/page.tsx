        ...
        <SectionContainer className="relative">
          <motion.div
            ...
            <p className="text-white/65 text-lg font-light leading-relaxed max-w-2xl">
              Real estate guides, investment trends, Dhaka property insights,
              legal taxes, and interior tips — everything you need for confident
              property decisions.
            </p>
          </motion.div>
              ...
              {filteredPosts.length === 0 ? (
                <motion.div
                  ...
                  <p className="text-sm text-muted-foreground mt-1 max-w-xs mx-auto font-light">
                    Try searching for another topic or clear the current
                    filters.
                  </p>
                  {hasFilters && (
                    <Button
