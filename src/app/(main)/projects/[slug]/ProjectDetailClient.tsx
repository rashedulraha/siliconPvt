      ...
      <div className="bg-background min-h-screen">
        <SectionContainer className="py-8 lg:py-12">
          ...
          <motion.div
            ...
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 text-muted-foreground hover:text-accent text-sm font-medium transition-colors group">
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-8 lg:gap-10 items-start">
            ...
            <motion.div
              ...
              {project.images.length > 0 && (
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 rounded-2xl overflow-hidden">
                  {project.images.slice(0, 4).map((src, i) => (
                    <div
                      key={i}
                      className={`relative overflow-hidden bg-muted rounded-xl ${i === 0 ? "sm:col-span-2 aspect-[16/8]" : "aspect-[4/3]"}`}>
                      <Image
                        src={src}
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2 items-center">
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-[0.08em] uppercase border ${STATUS_STYLES[project.status] ?? ""}`}>
            ...
            <motion.aside
              ...
              <Link
                href="/contact"
                className="flex items-center justify-center gap-2 w-full h-12 rounded-xl gold-shimmer text-accent-foreground font-bold text-sm shadow-soft hover:brightness-110 hover:scale-[1.01] transition-all duration-300">
