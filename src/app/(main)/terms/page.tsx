        ...
        <SectionContainer>
          <div className="max-w-3xl mx-auto">
            ...
            prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
              <p>
                By accessing or using the Silicon Real Estate (Pvt.) Ltd.
              ...
              <p>
                ...
                property listings, prices, and availability are subject to
                change without notice. Silicon Real Estate (Pvt.) Ltd. makes no
                warranties, express or implied, regarding the completeness,
                accuracy, or reliability of information presented on this
                website.
              </p>

              <h2>2. Property Listings</h2>
              <p>
                Property details, images, floor plans, and pricing are provided
                in good faith but may not reflect real-time market conditions or
                current availability. Users are strongly advised to
                independently verify all information before making any financial
                commitment. Silicon Real Estate (Pvt.) Ltd. acts as an
                intermediary and is not responsible for disputes arising between
              ...
              <p>
                ...
                their use and enjoyment of the site. You must not submit false
                or misleading information, attempt to gain unauthorised access
                to any part of our platform, or use automated tools to scrape or
                harvest content from this website.
              </p>
              ...
              <p>
                ...
                protected under applicable copyright and trademark law. No
                content may be reproduced, distributed, or used without prior
                written consent from Silicon Real Estate (Pvt.) Ltd.
              </p>
              ...
              <p>
                ...
                website or reliance on information published herein. This
                includes, without limitation, loss of income, loss of profits,
                or loss of data.
              </p>
              ...
              <p>
                ...
                the competent courts of Dhaka, Bangladesh.
              </p>
