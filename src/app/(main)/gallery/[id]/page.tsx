...
export default function GalleryDetailPage() {
		...
		return (
			<div className="min-h-screen flex flex-col items-center justify-center gap-4 text-center px-4">
				...
				<p className="text-muted-foreground text-sm">
					This item may have been removed from the gallery.
				</p>
				<Link
					href="/gallery"
	...
	const handlePrev = () =>
		setActiveImg((p) => (p - 1 + item.images.length) % item.images.length);
						...
						<div className="sticky top-36 bg-card border border-border/70 rounded-3xl p-6 space-y-5">
							<div className="space-y-1.5">
								...
								<p className="text-xs text-muted-foreground font-light leading-relaxed">
									Transportation from our Mohammadpur office to Silicon City is
									fully arranged.
								</p>
							</div>
							<a
