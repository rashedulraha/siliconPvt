        ...
        <SectionContainer className="relative z-10">
          <div className="max-w-3xl space-y-4 text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium font-heading text-white tracking-tight leading-tight">
              Get in Touch <span className="text-accent font-semibold">with Us</span>
            </h1>
          ...
          <div className="space-y-12 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-7 bg-card border border-border/70 rounded-3xl p-8 sm:p-10 space-y-6 text-left">
                ...
                <div className="space-y-4 text-xs sm:text-sm text-muted-foreground font-light">
                  ...
                  <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-muted/40 border border-border/40">
                    ...
                    <div>
                      <span className="font-semibold text-foreground font-heading block">Corporate Address:</span>
                      <span>2/3 (2nd Floor), Block # A, Iqbal Road, Mohammadpur, Dhaka-1207, Bangladesh</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-muted/40 border border-border/40">
                    ...
                    <div>
                      <span className="font-semibold text-foreground font-heading block">Phone & Mobile Numbers:</span>
                  ...
                  <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-300">
                    ...
                    <div>
                      <span className="font-semibold font-heading block">Official WhatsApp:</span>
                      <span>+880 12 345 678 <span className="font-normal">(Message us instantly for quick support)</span></span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3 p-4 rounded-2xl bg-muted/40 border border-border/40">
                      ...
                      <div>
                        <span className="font-semibold text-foreground font-heading block">Official Emails:</span>
                        <span className="block truncate">info@siliconrealestatepvtltd.com</span>
                        <span className="block truncate text-muted-foreground/80">siliconrealestate@gmail.com</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 rounded-2xl bg-muted/40 border border-border/40">
                      ...
                      <div>
                        <span className="font-semibold text-foreground font-heading block">Official Website:</span>
                        <span className="text-primary font-medium">siliconrealestatepvtltd.com</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 text-xs sm:text-sm font-light">
                    {[
                      ...
                      <div
                        ...
                        <span className="font-medium font-heading text-foreground">{item.day}</span>
                    ...
                    <div className="flex items-center justify-between p-2.5 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400">
                      ...
                      <span className="font-mono font-semibold">Closed (Weekly Holiday)</span>
                    </div>
                  </div>
                </div>

                <div className="p-4 rounded-2xl bg-primary/10 border border-primary/20 text-xs font-light text-primary leading-relaxed">
                  <strong>Note:</strong> For inquiries outside official business hours, please feel free to send us an email, and our team will get back to you on the next business day.
                </div>
              </div>
              ...
              <div className="lg:col-span-7 bg-card border border-border/70 rounded-3xl p-8 sm:p-10 space-y-8 text-left">
                <div className="space-y-1 border-b border-border/50 pb-4">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground font-light">
                    Fill out the form below, and our property consultants will contact you within 24 hours.
                  </p>
                </div>
                ...
                {submitted && (
                  <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-medium flex items-center gap-2">
                    ...
                    <span>Thank you for your message! Our property consultant team will contact you within 24 hours.</span>
                  </div>
                )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        <option value="Legal Document Verification">Legal Document Verification</option>
              ...
              <div className="lg:col-span-5 bg-dark-hero rounded-3xl p-8 sm:p-10 text-white space-y-6 border border-white/15 text-left flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 text-xs sm:text-sm text-white/80 font-light leading-relaxed">
                    <p>
                      "Silicon City" is strategically located in Bara Badeshi Mouza, Savar, right next to the Turag River and adjacent to Mohammadpur Beribadh.
                    </p>
                    <p>
                      We arrange physical site guided tours for our clients directly from our Corporate Office in Mohammadpur.
                    </p>
                  </div>
                </div>

                <div className="p-4 rounded-2xl bg-accent/15 border border-accent/30 text-xs font-light text-accent leading-relaxed">
                  <strong>How to Book:</strong> To book a guided vehicle tour, please call our hotline or submit the contact form with the subject "Schedule Site Visit" at least 24 hours in advance.
                </div>
              </div>
            ...
            <div className="bg-card border border-border/70 rounded-3xl p-8 sm:p-10 space-y-6 text-left w-full">
              <div className="space-y-1 border-b border-border/50 pb-4">
                ...
                <h2 className="text-xl sm:text-2xl font-semibold font-heading text-foreground">
                  Silicon Real Estate Corporate Office, Iqbal Road, Mohammadpur, Dhaka.
                </h2>
                <p className="text-xs sm:text-sm text-muted-foreground font-light">
                  "Our corporate office is conveniently situated near the historic Shia Mosque and Town Hall, making it easily accessible from any part of Dhaka City."
                </p>
              </div>
