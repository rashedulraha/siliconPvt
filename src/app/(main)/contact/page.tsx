...
export default function ContactPage() {
      ...
      : [
          {
            ...
            category: "land",
            description: "Premium ready-to-build residential plots in Mohammadpur."
          },
          {
            id: "prop-002",
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    } else if (!/^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$/.test(clientPhone)) {
  ...
  return (
    <>
      <PageSEO 
        ...
        description={state.seo.contact.description || "Get in touch with our luxury real estate specialists for site visits and inquiries."} 
      />
        ...
        <Container className="relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 mb-5">
              ...
              <span className="text-[10px] font-semibold tracking-wider text-accent uppercase">EXPERIENCE CENTRE</span>
            </div>
            ...
            <p className="text-white/60 text-lg font-light max-w-xl leading-relaxed">
              Schedule an exclusive private viewing of our premier properties or start a conversation with our dedicated investment advisors.
            </p>
          </motion.div>
        </Container>
      </section>
          ...
          <div className="grid lg:grid-cols-[40%_1fr] gap-10 xl:gap-16 items-start">
            ...
            >
              <div className="bg-card/70 dark:bg-[#111E35]/60 backdrop-blur-md rounded-3xl border border-border/40 dark:border-neutral-800/40 p-8 shadow-soft">
                <h2 className="text-sm font-semibold tracking-wider text-accent uppercase mb-8">HEADQUARTERS</h2>
                ...
                <div className="space-y-8">
                  ...
                  <div className="group flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold text-muted-foreground tracking-wider uppercase mb-1">VISIT US</p>
                      <p className="font-medium text-foreground text-sm leading-relaxed">
                        {siteSettings.address || "2/3 (2nd Floor), Block A, Iqbal Road, Mohammadpur, Dhaka-1207"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold text-muted-foreground tracking-wider uppercase mb-1">CALL US</p>
                      <div className="space-y-1">
                        <a href={`tel:${siteSettings.contactPhone || "+8801712345678"}`} className="block font-medium text-foreground text-sm hover:text-accent transition-colors">
                          {siteSettings.contactPhone || "+880 1712 345 678"} (Hotline)
                        </a>
                        <a href="tel:+88028123456" className="block font-medium text-foreground text-sm hover:text-accent transition-colors">
                  ...
                  <div className="group flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold text-muted-foreground tracking-wider uppercase mb-1">EMAIL US</p>
                      <a href={`mailto:${siteSettings.contactEmail || "info@siliconrealestate.com"}`} className="font-medium text-foreground text-sm hover:text-accent transition-colors break-all">
                        {siteSettings.contactEmail || "info@siliconrealestate.com"}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold text-muted-foreground tracking-wider uppercase mb-1">BUSINESS HOURS</p>
                      <p className="font-medium text-foreground text-sm leading-relaxed">
                        {siteSettings.businessHours || "Sun – Thu: 9:00 AM – 6:00 PM"}
                      </p>
                      <p className="text-xs text-muted-foreground font-light mt-0.5">Friday & Saturday Closed</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-border/40 dark:border-neutral-800/40 mt-8 pt-8">
                  <p className="text-[10px] font-semibold text-muted-foreground tracking-wider uppercase mb-4">CONNECT ONLINE</p>
                  <div className="flex flex-wrap gap-3">
                    {[
                      { icon: FacebookIcon, href: siteSettings.social?.facebook || "https://facebook.com", name: "Facebook" },
                      { icon: TwitterIcon, href: siteSettings.social?.twitter || "https://twitter.com", name: "X" },
                      { icon: InstagramIcon, href: siteSettings.social?.instagram || "https://instagram.com", name: "Instagram" },
                      { icon: LinkedinIcon, href: siteSettings.social?.linkedin || "https://linkedin.com", name: "LinkedIn" },
                      { icon: YoutubeIcon, href: siteSettings.social?.youtube || "https://youtube.com", name: "YouTube" }
                    ].map((soc, idx) => (
                      <a 
                        key={idx}
                        href={soc.href}
                    ...
                    {!isSuccess ? (
                              ...
                              {step === 1 && (
                                <div className="space-y-4">
                                  <p className="text-xs text-muted-foreground font-light mb-2">
                                    Please select which luxury development or plot boundary you would like to inspect.
                                  </p>
                                  <div className="grid gap-3.5">
                                    {projects.map((proj) => (
                                      <button
                                        key={proj.id}
                                        type="button"
                                        onClick={() => setSelectedPropertyId(proj.id)}
                                        className={cn(
                                  ...
                                  {errors.property && (
                                    <p className="text-xs text-destructive mt-1 font-medium">{errors.property}</p>
                                  )}
                                </div>
                              )}
                                      ...
                                      {nextWorkingDays.map((wd) => (
                                        ...
                                        >
                                          <span className={cn(
                                            ...
                                            selectedDate === wd.dateString ? "text-accent-foreground/80" : "text-muted-foreground"
                                          )}>
                                            {wd.dayName}
                                          </span>
                              ...
                              {step === 3 && (
                                <form onSubmit={handleBookingSubmit} className="space-y-6">
                                  <p className="text-xs text-muted-foreground font-light mb-4">
                                    Reviewing viewing of <strong className="font-semibold text-foreground">{selectedProject?.title}</strong> on <strong className="font-semibold text-foreground">{formattedDate}</strong> at <strong className="font-semibold text-foreground">{selectedTimeSlot}</strong>.
                                  </p>
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          <h3 className="font-semibold text-lg text-foreground">Site Visit Scheduled</h3>
                          <p className="text-xs text-muted-foreground font-light max-w-sm mx-auto">
                            Your reservation is confirmed. One of our Senior Relationship Managers will meet you at the location.
                          </p>
                        </div>
                        ...
                        <div className="bg-muted dark:bg-[#1A2F52]/40 rounded-xl p-4 text-left border border-border/40 dark:border-neutral-800/40 text-xs space-y-2 max-w-md mx-auto">
                          <div className="flex justify-between border-b border-border/40 pb-2">
                            ...
                            <span className="font-semibold text-accent">{confirmationId}</span>
                          </div>
                      ...
                      <form onSubmit={handleGeneralSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1">
                          ...
                          {generalErrors.subject && (
                            <p className="text-xs text-destructive mt-1">{generalErrors.subject}</p>
                          )}
                        </div>
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6 md:left-8 md:right-auto bg-card/90 dark:bg-[#111E35]/95 backdrop-blur-md border border-border/40 dark:border-neutral-800/40 rounded-2xl p-5 shadow-soft max-w-sm z-20">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-[10px] font-bold tracking-wider text-accent uppercase">HEADQUARTERS</span>
              </div>
