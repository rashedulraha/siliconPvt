					...
					<div className="max-w-3xl space-y-4">
						...
						<h1 className="text-3xl sm:text-4xl md:text-5xl font-medium font-heading text-white tracking-tight leading-tight">
							...
							<span className="text-accent font-semibold">
								Dhaka's Growth Corridors
							</span>
						</h1>

						<p className="text-white/80 text-xs sm:text-sm md:text-base font-light leading-relaxed">
							Silicon Real Estate connects discerning investors with legally
							verified, high-yielding land assets delivering consistent capital
							appreciation and secure long-term value.
						</p>
