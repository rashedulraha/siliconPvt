...
import { Search, MapPin, Building2, ArrowRight, ShieldCheck, CheckCircle2, PhoneCall } from "lucide-react";
...
export function HomePageClient() {
	...
	return (
		<div className="bg-background text-foreground min-h-screen overflow-x-hidden flex flex-col">
			...
			{/* ── IMAGE 2 VISUAL SHOWCASE: COMPANY CORE VALUES GRID (কোম্পানির মূল্যবোধ) ── */}
			<CompanyValuesGrid />
						...
						{featuredPlots.map((prop) => (
							...
							>
								<div className="relative h-48 w-full overflow-hidden bg-muted">
									<img
										src={prop.images[0] || "https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=1200"}
										alt={prop.title}
