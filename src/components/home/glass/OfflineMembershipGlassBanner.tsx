          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border-b border-white/15 pb-8">
            <div className="lg:col-span-8 space-y-3">
              ...
              <p className="text-white/80 text-xs sm:text-sm font-light leading-relaxed max-w-xl">
                Follow our simple 3-step physical office registration guide to secure your plot allocation.
              </p>
            </div>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-6 space-y-2">
              ...
              <p className="text-xs text-white/70 font-light leading-relaxed">
                Click the 'Download PDF Form' button below and print out the official application.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-6 space-y-2">
              ...
              <p className="text-xs text-white/70 font-light leading-relaxed">
                Fill out the printable form with NID number, representative/nominee details, and land RS/BS plot numbers.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-6 space-y-2">
              ...
              <p className="text-xs text-white/70 font-light leading-relaxed">
                Bring 2 passport-sized photographs, land deed photocopies, and the official BDT 1,000 application fee to our Corporate Office to secure your plot allocation.
              </p>
            </div>
          </div>
        </motion.div>
