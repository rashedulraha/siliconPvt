...
const servicesList = [
  {
    ...
    highlights: ["100% Verified Title", "Instant Registry", "Dispute-Free Plots"],
  },
  {
    num: "02",
  ...
  },
  {
    ...
    highlights: ["Low Booking Fee", "Zero Hidden Surcharges", "Flexible Installment Tenure"],
  },
];
