        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-12 xl:gap-16 items-center">
            ...
            <div className="space-y-6 text-left">
              ...
              <motion.p
                ...
                Silicon Real Estate (Pvt.) Ltd. is a verified framework
                authority in land development across Dhaka. We deliver
                high-yield architectural plots backed by secure transparent
                legal registry from booking straight to full demarcation.
              </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <motion.div
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed font-light">
                    Make verified, high-yield land investment tracks accessible
                    and secure across Bangladesh.
                  </p>
                </motion.div>
              </div>
              ...
              <div className="space-y-4 sm:pt-8">
                ...
                <motion.div
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed font-light">
                    "Delivering transparent infrastructure assets because
                    customer trust remains our highest currency."
                  </p>
                </motion.div>
                ...
                <motion.div
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed font-light">
                    Establish an uncompromised standard of absolute transparency
                    inside regional real estate.
                  </p>
                </motion.div>
