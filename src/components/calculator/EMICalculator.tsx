			...
			<CardContent className="p-6 space-y-6">
				...
				<div className="space-y-2 pt-2">
					<div className="flex items-center justify-between text-xs">
						...
						<span className="font-mono font-semibold text-neutral-900 dark:text-neutral-100">
							{interestRate}%{" "}
							{interestRate === 0 && (
								<span className="text-emerald-500 text-[9px] font-semibold tracking-wider ml-1 uppercase">
									(Interest Free Plan)
								</span>
							)}
						</span>
					...
					<div className="relative z-10 space-y-4">
						<div className="text-center py-2 border-b border-neutral-800 dark:border-neutral-800/60">
							...
							<AnimatePresence mode="wait">
								...
								>
									...
									<span className="text-[11px] text-neutral-400 font-sans tracking-normal font-light ml-1">
										/ month
									</span>
								</motion.p>
							</AnimatePresence>
						...
						<div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-[11px] font-light">
							...
							<div className="flex justify-between border-b border-neutral-800/40 pb-1.5">
								...
								<span
									className={`font-mono font-medium ${result.totalInterest > 0 ? "text-amber-400" : "text-emerald-500 font-semibold"}`}
								>
				...
				<div className="flex items-start gap-2 text-[10px] text-neutral-400 dark:text-neutral-500 bg-muted/40 p-3 rounded-xl border border-neutral-100 dark:border-neutral-900/40">
					...
					<span className="leading-normal">
						Calculations are estimations. Installment schedules align with RAJUK
						guidelines and deeds registered with the Ministry of Land. Zero
