                    ...
                    {hasMegaMenu && item.megaMenu && (
                      <AnimatePresence>
                        {isDropdownOpen && (
                          ...
                          >
                            <div className="w-[420px] sm:w-[440px] bg-popover text-popover-foreground border border-border rounded-2xl shadow-2xl overflow-hidden flex transition-all duration-200">
                  ...
                  {userMenuOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 rounded-xl overflow-hidden shadow-2xl py-1.5 z-50 border border-border/60 bg-popover text-popover-foreground">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-destructive hover:bg-destructive/[0.06] transition-colors text-left cursor-pointer"
                      >
            ...
            <div className="space-y-2 pt-2 border-t border-border/40">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 h-9 rounded-lg border border-destructive/20 text-destructive text-xs font-medium hover:bg-destructive/[0.04] transition-all cursor-pointer"
                >
