...
export function NewsletterSubscribe() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		setLoading(false);
		toast.success(
			"Thank you for subscribing! You'll receive our weekly insights.",
		);
		setEmail("");
	};
			...
			<div className="relative max-w-2xl mx-auto space-y-5">
				...
				<div className="space-y-1.5">
					...
					<p className="text-white/70 max-w-md mx-auto text-xs md:text-sm">
						Get the latest Dhaka property trends, buying guides, and exclusive
						market insights sent straight to your inbox.
					</p>
				</div>
