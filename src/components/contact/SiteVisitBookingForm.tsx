...
export function SiteVisitBookingForm() {
	...
	const handleNext = () => {
		...
		if (step === 2) {
			if (!selectedDate)
				currentErrors.date = "Please select a date for the visit";
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		const selectedProp = state.properties.find(
		...
		<div className="w-full bg-card rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 shadow-xl overflow-hidden text-neutral-800 dark:text-neutral-200">
			...
			<div className="p-6 border-b border-neutral-100 dark:border-neutral-900/60 flex items-center justify-between">
				<div>
					...
					<h3 className="text-sm font-semibold tracking-tight text-neutral-800 dark:text-neutral-100">
						Site Visit Booking
					</h3>
				</div>
				{step < 4 && (
						...
						>
							<div className="space-y-1">
								...
								<p className="text-[11px] text-neutral-400 dark:text-neutral-500 font-light">
									Choose the destination for your exclusive physical tour.
								</p>
							</div>
								...
								{availableProperties.map((prop) => (
									...
									>
										<div className="space-y-1.5">
											...
											<h5 className="text-xs font-bold text-neutral-800 dark:text-neutral-100 truncate">
												{prop.title}
											</h5>
					...
					{step === 2 && (
						...
						>
							<div className="space-y-1">
								...
								<p className="text-[11px] text-neutral-400 dark:text-neutral-500 font-light">
									Select a date and time slot for your guided micro-bus trip.
								</p>
							</div>
							...
							<div className="space-y-2">
								...
								<div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
									{bookingDays.map((day) => (
										...
										>
											<span className="text-[8px] uppercase tracking-wide text-neutral-400 mb-0.5">
												{day.dayName}
											</span>
					...
					{step === 3 && (
						...
						>
							<div className="space-y-1">
								...
								<p className="text-[11px] text-neutral-400 dark:text-neutral-500 font-light">
									Please verify details to finalize your booking invitation.
								</p>
							</div>
								...
								<div className="grid sm:grid-cols-2 gap-3">
									<div className="space-y-1">
										<Label
											...
											className="text-[9px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider block"
										>
											Full Name
										</Label>
						...
						>
							...
							<div className="space-y-2">
								...
								<p className="text-[11px] text-neutral-400 dark:text-neutral-500 max-w-[280px] mx-auto font-light leading-relaxed">
									Your VIP site visit ticket has been generated. Md. Aminul
									Islam will call you shortly to coordinate your micro-bus
									logistics.
								</p>
							</div>
							<div className="pt-2">
