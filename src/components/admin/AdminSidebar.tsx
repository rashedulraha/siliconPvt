...
const navItems = [
	...
	{ href: "/admin/inventory", label: "Land Plots & Inventory", icon: Building2 },
	{ href: "/admin/manage-slides", label: "Hero Banners", icon: ImageIcon },
	{ href: "/admin/site-settings", label: "Site Contact & Info", icon: Settings },
	{ href: "/admin/manage-content", label: "About & Leadership", icon: FileText },
